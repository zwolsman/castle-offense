...
public class InfoScreen implements Screen{
    ...
    public void create(){
        ...
        buttonBack.addListener(new HoverListener());
        ...
        buttonBack.setPosition(540, 580);
